...
static void check_invalidate_error_on_object_is_null(void **state) {
    ...
    assert_false(seahorse_array_list_p_invalidate(NULL));
...
static void check_init_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_init(NULL, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL,
                     seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_init_error_on_memory_allocation_failed(void **state) {
    ...
    assert_false(seahorse_array_list_p_init(&object, 10));
    calloc_is_overridden = false;
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_MEMORY_ALLOCATION_FAILED,
                     seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_init(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 10));
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_capacity_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_capacity(NULL, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL,
                     seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_capacity_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_capacity((void *) 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL,
                     seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_capacity(void **state) {
    ...
    uintmax_t out;
    assert_true(seahorse_array_list_p_capacity(&object, &out));
...
static void check_get_length_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_get_length(NULL, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}

static void check_get_length_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_get_length((void *) 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_get_length(void **state) {
    ...
    uintmax_t out;
    assert_true(seahorse_array_list_p_get_length(&object, &out));
    assert_int_equal(out, check);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_set_length_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_set_length(NULL, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_set_length_error_on_memory_allocation_failed(void **state) {
    ...
    calloc_is_overridden = true;
    assert_false(seahorse_array_list_p_set_length(&object, 1));
    calloc_is_overridden = false;
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_MEMORY_ALLOCATION_FAILED,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
...
static void check_set_length(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_true(seahorse_array_list_p_set_length(&object, 1));
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_shrink_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_shrink(NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_shrink(void **state) {
    ...
    assert_true(seahorse_array_list_p_shrink(&object));
...
static void check_add_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_add(NULL, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_add_error_on_memory_allocation_failed(void **state) {
    ...
    assert_true(seahorse_array_list_p_init(&object, 0));
    calloc_is_overridden = true;
    assert_false(seahorse_array_list_p_add(&object, 0));
    calloc_is_overridden = false;
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_MEMORY_ALLOCATION_FAILED,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
...
static void check_add(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_true(seahorse_array_list_p_add(
...
static void check_add_all_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_add_all(NULL, 1, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_add_all_error_on_count_is_zero(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_add_all((void *) 1, 0, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_COUNT_IS_ZERO, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}

static void check_add_all_error_on_values_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_add_all((void *) 1, 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_VALUES_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_add_all_error_on_memory_allocation_failed(void **state) {
    ...
    calloc_is_overridden = true;
    assert_false(seahorse_array_list_p_add_all(&object, count, values));
    calloc_is_overridden = false;
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_MEMORY_ALLOCATION_FAILED,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
...
static void check_add_all(void **state) {
    ...
    const uintmax_t count = sizeof(values) / sizeof(void *);
    assert_true(seahorse_array_list_p_add_all(&object, count, values));
    uintmax_t out;
    assert_true(seahorse_array_list_p_get_length(&object, &out));
...
static void check_remove_last_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_remove_last(NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_remove_last_error_on_array_is_null(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_false(seahorse_array_list_p_remove_last(&object));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_LIST_IS_EMPTY, seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_remove_last(void **state) {
    ...
    const uintmax_t count = sizeof(values) / sizeof(void *);
    assert_true(seahorse_array_list_p_add_all(&object, count, values));
    assert_true(seahorse_array_list_p_remove_last(&object));
    uintmax_t out;
    assert_true(seahorse_array_list_p_get_length(&object, &out));
...
static void check_insert_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_insert(NULL, 0, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_insert_error_on_index_out_of_bounds(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_false(seahorse_array_list_p_insert(&object, 0, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_insert(void **state) {
    ...
    assert_true(seahorse_array_list_p_insert(&object, 0, 0));
    assert_true(seahorse_array_list_p_get_length(&object, &out));
...
static void check_insert_all_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_insert_all(NULL, 0, 1, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_insert_all_error_on_count_is_zero(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_insert_all((void *) 1, 0, 0, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_COUNT_IS_ZERO, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_insert_all_error_on_values_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_insert_all((void *) 1, 0, 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_VALUES_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_insert_all_error_on_index_out_of_bounds(void **state) {
    ...
    assert_false(seahorse_array_list_p_insert_all(&object, 0, count, values));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_insert_all(void **state) {
    ...
    assert_true(seahorse_array_list_p_get_length(&object, &out));
    assert_int_equal(out, 1);
    assert_true(seahorse_array_list_p_insert_all(&object, 0, count, values));
    assert_true(seahorse_array_list_p_get_length(&object, &out));
...
static void check_remove_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_remove(NULL, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_remove_error_on_index_is_out_of_bounds(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_false(seahorse_array_list_p_remove(&object, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_remove(void **state) {
    ...
    assert_true(seahorse_array_list_p_get_length(&object, &out));
    assert_int_equal(out, 1);
    assert_true(seahorse_array_list_p_remove(&object, 0));
    assert_true(seahorse_array_list_p_get_length(&object, &out));
...
static void check_remove_all_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_remove_all(NULL, 0, 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_remove_all_error_on_count_is_zero(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_remove_all((void *) 1, 0, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_COUNT_IS_ZERO, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_remove_all_error_on_index_is_out_of_bounds(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_false(seahorse_array_list_p_remove_all(&object, 0, 10));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_remove_all(void **state) {
    ...
    assert_true(seahorse_array_list_p_get_length(&object, &out));
    assert_int_equal(out, count);
    assert_true(seahorse_array_list_p_remove_all(&object, 1, 3));
    assert_true(seahorse_array_list_p_get_length(&object, &out));
...
static void check_get_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_get(NULL, 0, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_get_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_get((void *) 1, 0, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_get_error_on_index_is_out_of_bounds(void **state) {
    ...
    assert_true(seahorse_array_list_p_init(&object, 0));
    void *out;
    assert_false(seahorse_array_list_p_get(&object, 0, &out));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_get(void **state) {
    ...
    void *out;
    assert_true(seahorse_array_list_p_get(&object, 0, &out));
...
static void check_set_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_set(NULL, 0, 0));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_set_error_on_index_is_out_of_bounds(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_false(seahorse_array_list_p_set(&object, 10, (void *)21));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_INDEX_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_set(void **state) {
    ...
    assert_true(seahorse_array_list_p_set(&object, 0, check));
    assert_true(seahorse_array_list_p_get(&object, 0, &out));
    assert_ptr_equal(out, check);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_first_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_first(NULL, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_first_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_first((void *) 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_first_error_on_array_is_empty(void **state) {
    ...
    assert_true(seahorse_array_list_p_init(&object, 0));
    void **out;
    assert_false(seahorse_array_list_p_first(&object, &out));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_LIST_IS_EMPTY, seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_first(void **state) {
    ...
    assert_true(seahorse_array_list_p_add(&object, check));
    void **out;
    assert_true(seahorse_array_list_p_first(&object, &out));
    assert_ptr_equal(*out, check);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_last_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_last(NULL, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_last_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_last((void *) 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_last_error_on_array_is_empty(void **state) {
    ...
    assert_true(seahorse_array_list_p_init(&object, 0));
    void **out;
    assert_false(seahorse_array_list_p_last(&object, &out));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_LIST_IS_EMPTY,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_last(void **state) {
    ...
    assert_true(seahorse_array_list_p_add(&object, check));
    void **out;
    assert_true(seahorse_array_list_p_last(&object, &out));
    assert_ptr_equal(*out, check);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_next_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_next(NULL, (void *) 1, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_next_error_on_item_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_next((void *) 1, NULL, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_ITEM_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}

static void check_next_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_next((void *) 1, (void *) 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_next_error_on_item_is_out_of_bounds(void **state) {
    ...
    assert_true(seahorse_array_list_p_set_length(&object, 1));
    void **item = (void **) 1;
    assert_false(seahorse_array_list_p_next(&object, item, &item));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_next_error_on_item_end_of_sequence(void **state) {
    ...
    assert_true(seahorse_array_list_p_set_length(&object, 1));
    void **item;
    assert_true(seahorse_array_list_p_first(&object, &item));
    assert_false(seahorse_array_list_p_next(&object, item, &item));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_END_OF_SEQUENCE, seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_next(void **state) {
    ...
    struct seahorse_array_list_p object;
    assert_true(seahorse_array_list_p_init(&object, 0));
    assert_true(seahorse_array_list_p_set_length(&object, 2));
    void **item;
    assert_true(seahorse_array_list_p_first(&object, &item));
    assert_true(seahorse_array_list_p_next(&object, item, &item));
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_prev_error_on_object_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_prev(NULL, (void *) 1, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OBJECT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_prev_error_on_item_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_prev((void *) 1, NULL, (void *) 1));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_ITEM_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_prev_error_on_out_is_null(void **state) {
    seahorse_error = SEAHORSE_ERROR_NONE;
    assert_false(seahorse_array_list_p_prev((void *) 1, (void *) 1, NULL));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_OUT_IS_NULL, seahorse_error);
    seahorse_error = SEAHORSE_ERROR_NONE;
}
...
static void check_prev_error_on_item_is_out_of_bounds(void **state) {
    ...
    assert_true(seahorse_array_list_p_set_length(&object, 1));
    void **item = (void **) 1;
    assert_false(seahorse_array_list_p_prev(&object, item, &item));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_ITEM_IS_OUT_OF_BOUNDS,
                     seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_prev_error_on_item_end_of_sequence(void **state) {
    ...
    assert_true(seahorse_array_list_p_set_length(&object, 1));
    void **item;
    assert_true(seahorse_array_list_p_last(&object, &item));
    assert_false(seahorse_array_list_p_prev(&object, item, &item));
    assert_int_equal(SEAHORSE_ARRAY_LIST_P_ERROR_END_OF_SEQUENCE, seahorse_error);
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
...
static void check_prev(void **state) {
    ...
    void **item;
    assert_true(seahorse_array_list_p_last(&object, &item));
    assert_true(seahorse_array_list_p_prev(&object, item, &item));
    assert_true(seahorse_array_list_p_invalidate(&object));
    seahorse_error = SEAHORSE_ERROR_NONE;
}
