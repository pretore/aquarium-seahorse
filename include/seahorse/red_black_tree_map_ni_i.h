#ifndef _SEAHORSE_RED_BLACK_TREE_MAP_NI_I_H_
#define _SEAHORSE_RED_BLACK_TREE_MAP_NI_I_H_
...
#define SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OBJECT_IS_NULL               1
#define SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OUT_IS_NULL                  2
#define SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_VALUE_IS_NULL                3
#define SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_ALREADY_EXISTS           4
#define SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_MEMORY_ALLOCATION_FAILED     5
#define SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_NOT_FOUND                6
...
bool seahorse_red_black_tree_map_ni_i_count(
        const struct seahorse_red_black_tree_map_ni_i *object,
        uintmax_t *out);
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_VALUE_IS_NULL if value is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_ALREADY_EXISTS if the
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_NOT_FOUND if key could
 * not be found.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_MEMORY_ALLOCATION_FAILED if
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_NOT_FOUND if key nor a
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_NOT_FOUND if no higher
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_KEY_NOT_FOUND if no lower
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_MAP_IS_EMPTY if tree map is
 * empty.
 */
...
bool seahorse_red_black_tree_map_ni_i_get_entry(
        const struct seahorse_red_black_tree_map_ni_i *object,
        uintmax_t key,
        const struct seahorse_red_black_tree_map_ni_i_entry **out);
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OBJECT_IS_NULL if object is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_ENTRY_IS_NULL if entry is
 * <i>NULL</i>.
 */
 ...
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_OUT_IS_NULL if out is
 * <i>NULL</i>.
 * @throws SEAHORSE_RED_BLACK_TREE_MAP_NI_I_ERROR_END_OF_SEQUENCE if there is
 * no next entry.
 */
...
#endif /* _SEAHORSE_RED_BLACK_TREE_MAP_NI_I_H_ */
