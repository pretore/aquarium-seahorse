#ifndef _SEAHORSE_ARRAY_LIST_I_H_
#define _SEAHORSE_ARRAY_LIST_I_H_
...
#define SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL                      1
#define SEAHORSE_ARRAY_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED            2
#define SEAHORSE_ARRAY_LIST_I_ERROR_OUT_IS_NULL                         3
#define SEAHORSE_ARRAY_LIST_I_ERROR_VALUE_IS_NULL                       4
#define SEAHORSE_ARRAY_LIST_I_ERROR_COUNT_IS_ZERO                       5
#define SEAHORSE_ARRAY_LIST_I_ERROR_VALUES_IS_NULL                      6
#define SEAHORSE_ARRAY_LIST_I_ERROR_LIST_IS_EMPTY                       7
#define SEAHORSE_ARRAY_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS              8
 ...
 * <p>The actual <u>array list instance is not deallocated</u> since it may
 * have been embedded in a larger structure.</p>
 * @param [in] object instance to be invalidated.
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 */
bool seahorse_array_list_i_invalidate(struct seahorse_array_list_i *object);
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 */
bool seahorse_array_list_i_capacity(const struct seahorse_array_list_i *object,
                                    uintmax_t *out);
...
bool seahorse_array_list_i_get_length(
        const struct seahorse_array_list_i *object,
        uintmax_t *out);
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if there is not
 * enough memory to set the array list length.
 */
bool seahorse_array_list_i_set_length(struct seahorse_array_list_i *object,
                                      uintmax_t length);
 ...
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 */
bool seahorse_array_list_i_shrink(struct seahorse_array_list_i *object);
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_VALUE_IS_NULL if value is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if there is not
 * enough memory to add another value.
 */
bool seahorse_array_list_i_add(struct seahorse_array_list_i *object,
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_COUNT_IS_ZERO if count is zero.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_VALUES_IS_NULL is values is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if there is not
 * enough memory to all the values.
 */
bool seahorse_array_list_i_add_all(struct seahorse_array_list_i *object,
                                   uintmax_t count,
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_LIST_IS_EMPTY if the array list is empty.
 */
bool seahorse_array_list_i_remove_last(struct seahorse_array_list_i *object);
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_VALUE_IS_NULL is value is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_INDEX_IS_OUT_OF_BOUNDS if at does not
 * refer to an item contained within the array list.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if there is not
 * enough memory to add another item.
 */
bool seahorse_array_list_i_insert(struct seahorse_array_list_i *object,
                                  uintmax_t at,
                                  const struct sea_turtle_integer *value);
 ...
 * refer to an item contained within the array list.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_COUNT_IS_ZERO if count is zero.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_VALUES_IS_NULL if values is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_MEMORY_ALLOCATION_FAILED if there is not
 * enough memory to insert all the values into the array list.
 */
bool seahorse_array_list_i_insert_all(struct seahorse_array_list_i *object,
                                      uintmax_t at,
                                      uintmax_t count,
                                      const struct sea_turtle_integer *values);
 ...
 * refer to an item contained within the array list.
 */
bool seahorse_array_list_i_remove(struct seahorse_array_list_i *object,
                                  uintmax_t at);
 ...
 * refer to an item contained within the array list.
 */
bool seahorse_array_list_i_remove_all(struct seahorse_array_list_i *object,
                                      uintmax_t at,
                                      uintmax_t count);
 ...
 * refer to an item contained within the array list.
 */
bool seahorse_array_list_i_get(const struct seahorse_array_list_i *object,
                               uintmax_t at,
 ...
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_LIST_IS_EMPTY if the array list is empty.
 */
bool seahorse_array_list_i_first(const struct seahorse_array_list_i *object,
                                 struct sea_turtle_integer **out);
 ...
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_LIST_IS_EMPTY if the array list is empty.
 */
bool seahorse_array_list_i_last(const struct seahorse_array_list_i *object,
                                struct sea_turtle_integer **out);
 ...
 * @return On success true, otherwise false if an error has occurred.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OBJECT_IS_NULL if object is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_ITEM_IS_NULL if item is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_OUT_IS_NULL if out is <i>NULL</i>.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_ITEM_IS_OUT_OF_BOUNDS if item is not
 * contained within the array list.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_END_OF_SEQUENCE if there is no next item.
 */
bool seahorse_array_list_i_next(const struct seahorse_array_list_i *object,
 ...
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_ITEM_IS_OUT_OF_BOUNDS if item is not
 * contained within the array list.
 * @throws SEAHORSE_ARRAY_LIST_I_ERROR_END_OF_SEQUENCE if there is no
 * previous item.
 */
bool seahorse_array_list_i_prev(const struct seahorse_array_list_i *object,
                                const struct sea_turtle_integer *item,
                                struct sea_turtle_integer **out);

#endif /* _SEAHORSE_ARRAY_LIST_I_H_ */
