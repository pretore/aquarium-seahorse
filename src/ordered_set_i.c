...
#include "private/ordered_set_i.h"

#ifdef TEST
#include <test/cmocka.h>
#endif

#define INVOKABLE   (*(struct seahorse_ordered_set_i **) object)

#pragma mark stream_i -

bool seahorse_ordered_set_i_first(
        const struct seahorse_ordered_set_i *const object,
        const struct sea_turtle_integer **const out) {
    if (!object) {
        seahorse_error = SEAHORSE_ORDERED_SET_I_ERROR_OBJECT_IS_NULL;
        return false;
    }
    if (!out) {
        seahorse_error = SEAHORSE_ORDERED_SET_I_ERROR_OUT_IS_NULL;
        return false;
    }
...
bool seahorse_ordered_set_i_remove_item(
        struct seahorse_ordered_set_i *const object,
    ...
    if (!item) {
        seahorse_error = SEAHORSE_ORDERED_SET_I_ERROR_ITEM_IS_NULL;
        return false;
    }
    return INVOKABLE->set_i
            .collection_i
...
bool seahorse_ordered_set_i_add(
    ...
    if (!value) {
        seahorse_error = SEAHORSE_ORDERED_SET_I_ERROR_VALUE_IS_NULL;
        return false;
    }
    return INVOKABLE->set_i
            .add(object, value);
